...
class Fragment_Quiz_Five : Fragment() {
   private lateinit var binding: FragmentQuiz5Binding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.radioGroup.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener{
            ...
            navigator().add(4,selected)
        })

        binding.question.text = requireArguments().getString(Fragment_Quiz_Five.ARG_QUESTION_VALUE)!!
        binding.optionOne.text = requireArguments().getString(Fragment_Quiz_Five.ARG_ANSWER1_VALUE)
        binding.optionTwo.text = requireArguments().getString(Fragment_Quiz_Five.ARG_ANSWER2_VALUE)
        binding.optionThree.text = requireArguments().getString(Fragment_Quiz_Five.ARG_ANSWER3_VALUE)
        binding.optionFour.text = requireArguments().getString(Fragment_Quiz_Five.ARG_ANSWER4_VALUE)
        binding.optionFive.text = requireArguments().getString(Fragment_Quiz_Five.ARG_ANSWER5_VALUE)
        binding.submit.setOnClickListener{
            navigator().goToFragmentResult()
            navigator().add(4,selected)
        }
        binding.root
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(question: String, answer1: String, answer2: String, answer3: String, answer4: String, answer5: String): Fragment_Quiz_Five {
            ...
            val fragment = Fragment_Quiz_Five()
