...
class Fragment_Quiz_Two : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.questionTextView.text =
            requireArguments().getString(Fragment_Quiz_Two.ARG_QUESTION_VALUE)!!
        binding.optionOne.text = requireArguments().getString(Fragment_Quiz_Two.ARG_ANSWER1_VALUE)
        binding.optionTwo.text = requireArguments().getString(Fragment_Quiz_Two.ARG_ANSWER2_VALUE)
        binding.optionThree.text =
            requireArguments().getString(Fragment_Quiz_Two.ARG_ANSWER3_VALUE)
        binding.optionFour.text =
            requireArguments().getString(Fragment_Quiz_Two.ARG_ANSWER4_VALUE)
        binding.optionFive.text =
            requireArguments().getString(Fragment_Quiz_Two.ARG_ANSWER5_VALUE)
        ...
        binding.nextButton.setOnClickListener {
            navigator().goToFragmentQuizThree()
            navigator().add(1,selected)
        }
        return binding.root
    }
