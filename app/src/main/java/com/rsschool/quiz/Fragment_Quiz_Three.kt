...
class Fragment_Quiz_Three: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.question.text = requireArguments().getString(Fragment_Quiz_Three.ARG_QUESTION_VALUE)!!
        binding.optionOne.text = requireArguments().getString(Fragment_Quiz_Three.ARG_ANSWER1_VALUE)
        binding.optionTwo.text = requireArguments().getString(Fragment_Quiz_Three.ARG_ANSWER2_VALUE)
        binding.optionThree.text =
            requireArguments().getString(Fragment_Quiz_Three.ARG_ANSWER3_VALUE)
        binding.optionFour.text =
            requireArguments().getString(Fragment_Quiz_Three.ARG_ANSWER4_VALUE)
        binding.optionFive.text =
            requireArguments().getString(Fragment_Quiz_Three.ARG_ANSWER5_VALUE)

        binding.nextButton.setOnClickListener {
            navigator().goToFragmentQuizFour()
            navigator().add(2,selected)
        }
    ...
    companion object {
        ...
        fun newInstance(
            ...
            val fragment = Fragment_Quiz_Three()
